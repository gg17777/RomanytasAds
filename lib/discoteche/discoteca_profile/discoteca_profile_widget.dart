                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(
                          discotecaProfileSerateRecord.serataAnnullata
                              ...
                              child: Padding(
                                ...
                                child: PageView(
                                  ...
                                  onPageChanged: (_) async {
                                    logFirebaseEvent(
                                        'DISCOTECA_PROFILE_PageView_hgxefxby_ON_W');
                                    logFirebaseEvent(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DISCOTECA_PROFILE_Row_rd5wu873_ON_TAP');
                                                  await Future.wait([
                                                    Future(() async {
                                                      logFirebaseEvent(
                                                ...
                                                if (!_model.descrizione)
                                                  Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'DISCOTECA_PROFILE_Text_wsxja5mu_ON_TAP');
                                                        await Future.wait([
                                                          Future(() async {
                                                            logFirebaseEvent(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'DISCOTECA_PROFILE_Text_n3bzekbd_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Text_launch_u_r_l');
                                                          await launchURL(
                                                              discotecaProfileSerateRecord
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DISCOTECA_PROFILE_StaticMap_5rp1haph_ON_');
                                                  logFirebaseEvent(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'DISCOTECA_PROFILE_Text_snom0xti_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Text_launch_u_r_l');
                                                          await launchURL(
                                                              discotecaProfileSerateRecord
