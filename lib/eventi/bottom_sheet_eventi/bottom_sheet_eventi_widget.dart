...
class BottomSheetEventiWidget extends StatefulWidget {
  const BottomSheetEventiWidget({
    super.key,
    required this.eventiRef,
  });

  final DocumentReference? eventiRef;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: StreamBuilder<EventiRecord>(
        stream: EventiRecord.getDocument(widget.eventiRef!),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'BOTTOM_SHEET_EVENTI_Icon_ojdpmep2_ON_TAP');
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'BOTTOM_SHEET_EVENTI_VEDI_EVENTO_BTN_ON_T');
