...
import '/eventi/lista_popup_eventi/lista_popup_eventi_widget.dart';
...
class _EventiProfileWidgetState extends State<EventiProfileWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventiRecord>(
      stream: EventiRecord.getDocument(widget.eventoRef!),
                    ...
                    child: Builder(
                      builder: (context) => Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENTI_PROFILE_PAGE_Icon_jkjutzts_ON_TAP');
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      fontFamily:
                                                                          'Montserrat',
                                                                      fontSize: eventiProfileEventiRecord.ingresso1Costo == ''
                                                                          ? 16.0
                                                                          : 14.0,
                                                                      letterSpacing:
                                                                          0.0,
                                                              ...
                                                              children: [
                                                                ...
                                                                Stack(
                                                                  children: [
                                                                    ...
                                                                    if ((eventiProfileEventiRecord.ingresso2nome !=
                                                                                '') &&
                                              ...
                                              if (eventiProfileEventiRecord
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'EVENTI_PROFILE_ENTRA_IN_LISTA_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_bottom_sheet');
                                              ...
                                              if (eventiProfileEventiRecord
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'EVENTI_PROFILE_PAGE_BIGLIETTI_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_launch_u_r_l');
                                                      await launchURL(
                                                          eventiProfileEventiRecord
