                              ...
                              child: Padding(
                                ...
                                child: PageView(
                                  ...
                                  onPageChanged: (_) async {
                                    logFirebaseEvent(
                                        'CONCERTO_IN_EVIDENZA_PROFILE_PageView_ac');
                                    logFirebaseEvent(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CONCERTO_IN_EVIDENZA_PROFILE_Row_q3afz7y');
                                                  await Future.wait([
                                                    Future(() async {
                                                      logFirebaseEvent(
                                                ...
                                                if (!_model.descrizione)
                                                  Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CONCERTO_IN_EVIDENZA_PROFILE_Text_9t17x1');
                                                        await Future.wait([
                                                          Future(() async {
                                                            logFirebaseEvent(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CONCERTO_IN_EVIDENZA_PROFILE_Text_f01qis');
                                                      logFirebaseEvent(
                                                          'Text_launch_u_r_l');
                                                      await launchURL(
                                                          concertoInEvidenzaProfileConcertiInEvidenzaRecord
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CONCERTO_IN_EVIDENZA_PROFILE_StaticMap_y');
                                                  logFirebaseEvent(
