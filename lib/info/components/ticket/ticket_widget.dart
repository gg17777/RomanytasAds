              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: BarcodeWidget(
                      data: containerTicketsRecord.reference.id,
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Stato biglietto: ${containerTicketsRecord.scanned ? 'Scannerizzato' : 'Non scannerizzato'}',
                          style:
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 0.0),
                        child: Text(
                          'Biglietti acquistati: ${containerTicketsRecord.peopleXticket.toString()}',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Montserrat',
                                    color: FlutterFlowTheme.of(context)
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Data Evento: ${dateTimeFormat(
                            "d/M/y",
                            containerTicketsRecord.eventDate,
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 0.0),
                        child: Text(
                          'Ticket ID: ${containerTicketsRecord.reference.id}',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Montserrat',
                                    color: FlutterFlowTheme.of(context)
