      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetAllNasoniRow:
            return GetAllNasoniRow(data);
          case GetNasoniByIdRow:
            return GetNasoniByIdRow(data);
          case GetAllBanglaRow:
            return GetAllBanglaRow(data);
          case GetBanglaByIdRow:
            return GetBanglaByIdRow(data);
          case GetCiboByIdRow:
            return GetCiboByIdRow(data);
          case GetAllCiboRow:
            return GetAllCiboRow(data);
          case GetAllCiboByZozzoniRow:
            return GetAllCiboByZozzoniRow(data);
          default:
            return null;
        }
