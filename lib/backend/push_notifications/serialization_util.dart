...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case GetAllNasoniRow:
        return GetAllNasoniRow(json.decode(param) as Map<String, dynamic>) as T;
      case GetNasoniByIdRow:
        return GetNasoniByIdRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case GetAllBanglaRow:
        return GetAllBanglaRow(json.decode(param) as Map<String, dynamic>) as T;
      case GetBanglaByIdRow:
        return GetBanglaByIdRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case GetCiboByIdRow:
        return GetCiboByIdRow(json.decode(param) as Map<String, dynamic>) as T;
      case GetAllCiboRow:
        return GetAllCiboRow(json.decode(param) as Map<String, dynamic>) as T;
      case GetAllCiboByZozzoniRow:
        return GetAllCiboByZozzoniRow(
