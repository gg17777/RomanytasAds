...
import 'eventi_home_log_out_model.dart';
export 'eventi_home_log_out_model.dart';

class EventiHomeLogOutWidget extends StatefulWidget {
  const EventiHomeLogOutWidget({super.key});

  static String routeName = 'eventiHomeLogOut';
  static String routePath = 'eventiHomeLogOut';

  @override
  State<EventiHomeLogOutWidget> createState() => _EventiHomeLogOutWidgetState();
}

class _EventiHomeLogOutWidgetState extends State<EventiHomeLogOutWidget>
    with TickerProviderStateMixin {
  late EventiHomeLogOutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventiHomeLogOutModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'eventiHomeLogOut'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EVENTI_HOME_LOG_OUT_eventiHomeLogOut_ON_');
      logFirebaseEvent('eventiHomeLogOut_custom_action');
      ...
      if (FFAppState().city == '') {
        logFirebaseEvent('eventiHomeLogOut_update_app_state');
      ...
      logFirebaseEvent('eventiHomeLogOut_update_page_state');
      ...
      if ((valueOrDefault<bool>(
          ...
          (valueOrDefault<bool>(
              ...
              null)) {
        logFirebaseEvent('eventiHomeLogOut_backend_call');
      ...
      if (((valueOrDefault<bool>(currentUserDocument?.syncContacts, false) ==
              ...
              (valueOrDefault<bool>(currentUserDocument?.syncContacts, false) ==
                  null)) &&
          loggedIn) {
        logFirebaseEvent('eventiHomeLogOut_navigate_to');
      ...
      if (_model.isCacheOverride!) {
        ...
        safeSetState(() {});
        logFirebaseEvent('eventiHomeLogOut_clear_query_cache');
        FFAppState().clearEventiCacheCache();
        logFirebaseEvent('eventiHomeLogOut_wait__delay');
      ...
      if (FFAppState().eventiState == 'discoteche') {
        logFirebaseEvent('eventiHomeLogOut_page_view');
      ...
      logFirebaseEvent('eventiHomeLogOut_set_dark_mode_settings');
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENTI_HOME_LOG_OUT_Text_krg8lgwo_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENTI_HOME_LOG_OUT_Text_p8yuxt6x_ON_TAP');
                            logFirebaseEvent('Text_page_view');
                            await _model.pageViewController?.animateToPage(
                              1,
                              duration: Duration(milliseconds: 500),
                    ...
                    child: Container(
                      ...
                      child: PageView(
                        ...
                        onPageChanged: (_) async {
                          logFirebaseEvent(
                              'EVENTI_HOME_LOG_OUT_PageView_8z30jyay_ON');
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'EVENTI_HOME_LOG_OUT_Row_w5oqvq53_ON_TAP');
                                                                  if (extraConcertItem
                                                                          .eventOrConcert ==
                                                                      'event') {
                                                                    logFirebaseEvent(
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'EVENTI_HOME_LOG_OUT_Row_leggl312_ON_TAP');
                                                                        if (loggedIn) {
                                                                                        ...
                                                                                        builder: (context) {
                                                                                          if (eventiDataItem.saltafila) {
                                                                                            return InkWell(
                                                                                              ...
                                                                                              highlightColor: Colors.transparent,
                                                                                              onTap: () async {
                                                                                                logFirebaseEvent('EVENTI_HOME_LOG_OUT_Image_3po07m0p_ON_TA');
                                                                                          ...
                                                                                          builder: (context) {
                                                                                            if (eventiDataItem.functionPhotoAI) {
                                                                                              return InkWell(
                                                                                                ...
                                                                                                highlightColor: Colors.transparent,
                                                                                                onTap: () async {
                                                                                                  logFirebaseEvent('EVENTI_HOME_LOG_OUT_Image_q9vnfeff_ON_TA');
                                                                                                  logFirebaseEvent('Image_bottom_sheet');
                                                                                                  await showModalBottomSheet(
                                                                                                    isScrollControlled: true,
                                                                                                    backgroundColor: Colors.transparent,
                                                                                              ...
                                                                                              return InkWell(
                                                                                                ...
                                                                                                highlightColor: Colors.transparent,
                                                                                                onTap: () async {
                                                                                                  logFirebaseEvent('EVENTI_HOME_LOG_OUT_Image_0rso7u0f_ON_TA');
                                                                                                  logFirebaseEvent('Image_bottom_sheet');
                                                                                                  await showModalBottomSheet(
                                                                                                    isScrollControlled: true,
                                                                                                    backgroundColor: Colors.transparent,
                                                                                              ...
                                                                                              return InkWell(
                                                                                                ...
                                                                                                highlightColor: Colors.transparent,
                                                                                                onTap: () async {
                                                                                                  logFirebaseEvent('EVENTI_HOME_LOG_OUT_Image_pz63df4q_ON_TA');
                                                                                                  logFirebaseEvent('Image_bottom_sheet');
                                                                                                  await showModalBottomSheet(
                                                                                                    isScrollControlled: true,
                                                                                                    backgroundColor: Colors.transparent,
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EVENTI_HOME_LOG_OUT_Icon_sgew6ek1_ON_TAP');
                                            await Future.wait([
                                              Future(() async {
                                                logFirebaseEvent(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EVENTI_HOME_LOG_OUT_Row_klkv6oka_ON_TAP');
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EVENTI_HOME_LOG_OUT_Container_7py5ax72_O');
                                                    ...
                                                    children: List.generate(
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'EVENTI_HOME_LOG_OUT_Row_vm5eb198_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Row_navigate_to');
                                              ...
                                              children: List.generate(
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'EVENTI_HOME_LOG_OUT_Row_e9cte9iu_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Row_navigate_to');
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EVENTI_HOME_LOG_OUT_Icon_f8amwcxw_ON_TAP');
