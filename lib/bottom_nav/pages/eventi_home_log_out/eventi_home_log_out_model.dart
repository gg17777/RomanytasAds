...
import '/index.dart';
import 'eventi_home_log_out_widget.dart' show EventiHomeLogOutWidget;
import 'package:flutter/material.dart';

class EventiHomeLogOutModel extends FlutterFlowModel<EventiHomeLogOutWidget> {
  ...
  // Stores action output result for [Custom Action - fetchVisibleEvents] action in eventiHomeLogOut widget.
  List<ConcertiInEvidenzaRecord>? concertiEv;
  // Stores action output result for [Custom Action - fetchEventsSorted] action in eventiHomeLogOut widget.
  List<EventiRecord>? eventis;
  // Stores action output result for [Custom Action - isOverrideCacheAction] action in eventiHomeLogOut widget.
