...
class _MyEventsWidgetState extends State<MyEventsWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'my_events'});
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'MY_EVENTS_PAGE_Icon_ogozaw95_ON_TAP');
                                                                      ...
                                                                      if (containerEventiRecord
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('MY_EVENTS_PAGE_Container_9cnesqgr_ON_TAP');
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder: (context) =>
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                logFirebaseEvent('MY_EVENTS_PAGE_Container_7sww9oel_ON_TAP');
                                                                                logFirebaseEvent('Container_navigate_to');
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'MY_EVENTS_INGRESSO_IN_LISTA_BTN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_bottom_sheet');
