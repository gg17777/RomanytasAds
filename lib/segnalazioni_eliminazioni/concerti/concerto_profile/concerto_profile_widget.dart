                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            _model.currentPageLink =
                              ...
                              imageUrl: concertoProfileConcertiRecord.locandina,
                              isShortLink: false,
                            );
                            ...
                            await widget.concertoRef!.update({
                              ...mapToFirestore(
                                {
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CONCERTO_PROFILE_Row_0pnbica1_ON_TAP');
                                                    await Future.wait([
                                                      Future(() async {
                                                        logFirebaseEvent(
                                                  ...
                                                  if (!_model.descrizione)
                                                    Align(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CONCERTO_PROFILE_Text_awnecm2g_ON_TAP');
                                                          await Future.wait([
                                                            Future(() async {
                                                              logFirebaseEvent(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'CONCERTO_PROFILE_Text_62fzx15v_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Text_launch_u_r_l');
                                                        await launchURL(
                                                            concertoProfileConcertiRecord
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CONCERTO_PROFILE_StaticMap_hv6cmzsw_ON_T');
                                                    logFirebaseEvent(
