...
Future<bool> swipeSecretUser(
  ...
  try {
    var secretParties = "secret_parties";
    var swipeActionsKey = 'secret_party_swipeActions';
    // Get a reference to Firestore
    final firestore = FirebaseFirestore.instance;

    // Reference to the event document
    final eventRef = firestore.collection(secretParties).doc(eventID);

    // Step 1: Log the swipe action
    await eventRef.collection(swipeActionsKey).add({
      'swiperID': swiperID,
      'swipedID': swipedID,
      ...
      if (matchQuery.docs.isNotEmpty) {
        ...
        try {
          ...
          const String cloudFunctionUrl =
              "https://us-central1-romanita-5nlemi.cloudfunctions.net/addUserToSecretLikes";
