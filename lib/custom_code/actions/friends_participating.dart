...
Future<List<DocumentReference>> friendsParticipating(
    DocumentReference eventRef) async {
  // Add your function code here!
  var user = FirebaseAuth.instance.currentUser;
  final peopleParticipating =
      await eventRef.collection("eventiParticiapting").get();
  ...
  var peopleParticipatingParsed = peopleParticipating.docs.map((doc) {
    ...
    return EventiParticiaptingRecord.fromSnapshot(doc);
  }).toList();
  ...
  var participatingUserRefs = peopleParticipatingParsed
      .map((e) => e.userParticipatingEventRef)
