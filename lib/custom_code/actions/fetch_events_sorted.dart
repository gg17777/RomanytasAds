...
Future<List<EventiRecord>> fetchEventsSorted(
    String city, bool verificato, String type) async {
  ...
  try {
    ...
    final querySnapshot = await FirebaseFirestore.instance
        ...
        .where('verificato', isEqualTo: verificato)
    ...
    final list =
        visibleEvents.map((e) => EventiRecord.fromSnapshot(e)).toList();
