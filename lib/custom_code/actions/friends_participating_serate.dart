...
Future<List<DocumentReference>> friendsParticipatingSerate(
    DocumentReference serateRef) async {
  // Add your function code here!
  var user = FirebaseAuth.instance.currentUser;
  final peopleParticipating =
      await serateRef.collection("participatingSerate").get();
  ...
  var peopleParticipatingParsed = peopleParticipating.docs.map((doc) {
    ...
    return ParticipatingSerateRecord.fromSnapshot(doc);
  }).toList();
  ...
  var participatingUserRefs = peopleParticipatingParsed
      .map((e) => e.userParticipatingSerateRef)
